...
(async () => {
  ...
  try {
    await waitForServer();
    for (const testFile of ["startup.ui.cjs", "emojiReader.ui.cjs", "journalLoading.ui.cjs", "allPages.ui.cjs", "chat.ui.cjs", "graphCommunities2D.ui.cjs", "graphUniverse.ui.cjs", "graphCommunities3D.ui.cjs", "graphFlight.ui.cjs", "paste.ui.cjs", "bulletThreading.ui.cjs"]) {
