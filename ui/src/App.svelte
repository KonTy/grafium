...
<div class="app-shell" class:zen={zenMode} class:wide-mode={wideMode}>
  ...
  <div class="app-layout" bind:this={appLayoutEl}>
    ...
    <!-- More menu popup -->
    {#if showMoreMenu}
      <div class="more-menu-backdrop" role="presentation" onclick={closeMoreMenu}></div>
      <div
        class="more-menu"
        role="menu"
        tabindex="-1"
        use:autofocus
        onkeydown={(event) => handleMenuKeydown(event, closeMoreMenu)}
      >
        <button role="menuitem" class="more-menu-item" onclick={() => { closeMoreMenu(); handleNavigate("__settings__"); }}>
        ...
        <button role="menuitem" class="more-menu-item" onclick={() => { closeMoreMenu(); handleNavigate("__chat__"); }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
          </svg>
          <span>Chat</span>
        </button>
        <button role="menuitem" class="more-menu-item" onclick={() => { closeMoreMenu(); handleNavigate("__jobs__"); }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button role="menuitem" class="more-menu-item" onclick={handleMobileOpenGraph}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>
          </svg>
          <span>Open Graph</span>
        </button>
        <button role="menuitem" class="more-menu-item" onclick={() => { closeMoreMenu(); handleNavigate("__import_media__"); }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button role="menuitem" class="more-menu-item" onclick={() => { closeMoreMenu(); handleNavigate("__import_books__"); }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button role="menuitem" class="more-menu-item" onclick={handleMobileCreateGraph}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <line x1="12" y1="5" x2="12" y2="19"></line>
            <line x1="5" y1="12" x2="19" y2="12"></line>
          </svg>
        ...
        <button role="menuitem" class="more-menu-item" onclick={handleMobileReindex}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
{#if showNewPageDialog}
  <div class="dialog-backdrop" role="presentation" use:dismissOnBackdrop={cancelNewPage}>
    <div class="dialog" role="dialog" aria-modal="true" aria-labelledby="new-page-title" tabindex="-1" onkeydown={dialogKeydown(cancelNewPage)}>
      <h3 class="dialog-title" id="new-page-title">New Page</h3>
      <input
        type="text"
        class="dialog-input"
...
{#if showCreateGraphDialog}
  <div class="dialog-backdrop" role="presentation" use:dismissOnBackdrop={cancelCreateGraph}>
    <div class="dialog" role="dialog" aria-modal="true" aria-labelledby="create-graph-title" tabindex="-1" onkeydown={dialogKeydown(cancelCreateGraph)}>
      ...
      <input
        ...
        onkeydown={(e) => { if (e.key === "Enter") confirmCreateGraph(); }}
        use:autofocus
      />
      <div class="dialog-actions">
